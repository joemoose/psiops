...
**Obscured**
Smoke, darkness, heavy rain, blinding light. Ranged attacks *through* this zone are at Disadvantage. Ranged attacks at 2+ hops *into* this zone are Impossible. Contact and Close attacks are unaffected. Lasts until cleared.

**Hazardous**
Fire, chemical spill, electrified water, and a collapsing structure. Entering or remaining in this zone costs HP (or a save) per round. Amount and type set by GM at scene creation or as the scene evolves.
...
**Sprint:** Cross 2 zone boundaries. No other action turns.
...
**Name zones for their function, not their geography.** *Killzone* instead of *Middle of the Road*. *Sniper Nest* instead of *Rooftop Corner*. Names carry tactical implications.

**Front-load the scene description.** When you declare Combat Mode, give one clear sentence per zone: *"The Street is Open Ground — crossing it will get you shot. The Alley is narrow, a c hokepoint, and it connects to the Back Lot. The Back Lot has a dumpster — Cover. The Rooftop overlooks all of it."* Players should be able to visualize and plan from that.
