...
Names of military weapons used in the 1980s follow.
...
Roll **2D6 + Attribute score**. The total determines the degree of success for your action as follows:
...
Whenever you make an **action roll**, gain momentum as follows:
...
When you **attack** a target to **deal damage**, roll **2D6 + Attribute** and apply the result.
...
When you **defend** against an attack and risk **taking damage**, roll **2D6 + Attribute** and apply the result.
...
If you take damage but have at least **1 HP**, you're still in the fight. If your HP is **0 or less**, roll **2D6 + STRENGTH** and subtract the amount by which your HP is below 0. Then apply the result. 
...
| **7–9** | You're *incapacitated* at **0 HP**. Take **2** *injuries* and **2** points of *stress*. You'll die in **10 minutes** unless a team member stabilizes you. |
| **10–12** | You're *down* and stable at **1 HP**, unconscious. Take **1** *injury* and **1** point of *stress*. A team member can get you back on your feet. |
...
To make a *stress check*, roll **2D6 + WILLPOWER**, and apply the result.
...
| **4** | Selfish | *Disadvantage* on all your *action rolls* that could benefit a team member. |
| **5** | Shutdown | You lose all your *momentum* and no longer gain any. |
| **6** | Weak | You have **-1 ARMOR**. |
