...
| 24 | **Empathy**: You can read a target’s emotions and subtly affect them. This includes changing a target’s NPC Reaction Roll result by one category up or down, the player’s choice. |
...
| 61 | **Telekinesis**: You can move objects up to 100kg with the power of your mind. Telekinetics can also be used offensively: attack a target within handgun range with a +3 damage modifier. |
