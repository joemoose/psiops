...
To create your character, follow these steps. Record the results of each step on your character sheet.
...
Set your maximum ***Hit Points*** to 6 and your starting ***Momentum Points*** to 2. These values are pre-listed on your character sheet.
...
| :-: | :- | :- |
| 11 | Agitator | Describe a persistent oppressive establishment that harmed you. Advance if your actions weakened it or helped others oppressed by it. |
...
| 13 | Blank Slate | Describe your most recent memory, like waking up in a vat a week ago or discovering your name from an unfamiliar wallet in your coat. Advance if your understanding of yourself or the world changes during the mission. |
...
| 21 | Champion | Describe your experiences with the creation, mistreatment, or elimination of humans like yourself with anomalous cognitive abilities. Advance if you proved they could and should stand on their own, or if you liberated another anomalous human. |
...
| 23 | Contractor | Describe how you ended up working with these weirdos in your unit. Advance if the mission went as you planned and you received your pay. |
...
| 31 | Deathwish | Describe how you concluded that nothing truly matters. Advance if you showed no fear of death or self-preservation during the mission. |
| 32 | Drifter | Describe the event that sent you drifting from place to place, never staying. Advance if you left no trace of your presence by the end of a mission, or if someone you met will always miss you. |
...
| 34 | Exile | Describe where you’re from and how you got stranded here. Advance if you’ve made progress or contacted someone from that place. |
| 35 | Fallout | Describe a complex catastrophe you’re responsible for. Advance if you meaningfully helped heal its aftermath. |
...
| 42 | Hothead | Describe your hopes for the future that others have belittled. Advance if a mission event aided your growth or proved your worth to a team member. |
...
| 44 | Latent | Describe the difficulty in finding a cause or purpose, or something to fight for. Advance if you overcame a challenge or obtained a valuable item beyond your expected ability. |
...
| 53 | Mythmaker | Describe how you want to be remembered in history. Advance if your actions made you a legend or ensured a group remembers your name. |
| 54 | Nemesis | Describe someone who wronged you and what they did. Advance if your own actions helped you achieve revenge or stop a similar injustice. |
| 55 | Old Dog | Describe your past exploits, retirement, return to action, and why you can’t go home yet. Advance if you’ve made progress toward returning home or demonstrated that an old dog can still learn new tricks. |
...
| 61 | Rationalist | Describe your well-vetted, rational worldview. Advance if you offer an honest, reasonable explanation for unfamiliar paranormal phenomena you encounter and are proven correct. |
...
| 63 | Rogue | Describe your main vice or pleasure, like money, romance, thrills, or pain. Advance if you obtained your fix unexpectedly during a mission. |
| 64 | Seeker | Describe the esoteric subject you’re most curious about. Advance if something you learned on the mission brought you closer to unlocking its secrets. |
| 65 | Shield | Describe someone or a concept you want to protect and what you aim to shield them from. Advance by preventing harm or taking steps to ensure better protection in the future. |
| 66 | True Believer | Describe an ethical ideal you cherish but find hard to achieve. Advance if something you did aligned with this ideal, even if it made life more challenging. |
...
Unlike *attributes*, your advanced specializations aren’t assigned numerical ratings. You either have the specialization, or you don’t.

| D66 | Specialization | Description |
| :-: | :- | :- |
| 11 | Advanced Navigation & Fire Control | Advanced training in dead reckoning on featureless terrain, urban navigation during blackout, and coordinating artillery and close air support precisely to avoid friendly fire. |
...
| 13 | Aviation Operations | Piloting fixed- and rotary-wing aircraft, including covert insertions, extractions, nap-of-the-earth flying, and field maintenance in operational conditions. |
...
| 16 | Combat Diving & Underwater Ops | Advanced training in closed-circuit rebreather, underwater navigation, combat swimming, and lock-out submersible procedures for covert maritime infiltration. |
...
| 22 | Combat Fitness | Exceptional physical performance surpassing standard military fitness, including sustained load-bearing, extreme endurance, and strength or agility feats in adverse conditions. |
| 23 | Combat Leadership | Maintaining unit effectiveness when plans fall apart, staying cohesive under fire, taking command during crises, and earning the trust of foreign and irregular allies. |
...
| 25 | Combat Tracking & Pursuit | Reading physical signs like footprints, disturbed vegetation, vehicle tracks, and recent activity indicators to track personnel or vehicles across terrain. |
| 26 | Concealment & Counter-Surveillance | Advanced concealment, counter-surveillance, and defeating electronic detection in urban and field environments. |
| 31 | Crime Scene & Intel Analysis | Reading sites to determine what happened, what’s disturbed, and what someone doesn’t want found. It includes dead-drop analysis, crime-scene forensics, surveillance detection, and intelligence assessment. |
...
| 33 | Documentation & Cover Operations | Creating and maintaining cover documentation, forging official records, and navigating foreign bureaucracies and checkpoints to move people, documents, and materiel without detection. |
...
| 35 | HUMINT Development | Navigating criminal networks and black markets to find contacts, acquire off-books materials, and assess situations or people for signs of impending issues. |
| 36 | Intelligence Tradecraft | Training in dead drops, surveillance detection routes, signal sites, brush passes, and covert communication and movement that keep operations invisible. |
| 41 | K9 & Animal Handler | Training and handling military working dogs, animals, or paranormal creatures for detection, tracking, and protection, including keeping them calm, controlled, or out of the way during missions. |
...
| 51 | Small Arms: Machine Gun | Establishing and maintaining fire superiority with light and general-purpose machine guns involves laying suppressive fire, managing ammunition during prolonged engagements, and keeping weapons operational under stress. |
...
| 53 | Small Arms: Shotgun | Ballistic breaching, close-quarters engagement, and choosing the right load, like breaching rounds, buckshot, or a slug, for the situation. |
...
| 55 | Small Arms: SMG | Engaging in close-quarters combat and suppressive fire with submachine guns, effective at contact distances when rifles are cumbersome, and a sidearm is inadequate. |
| 56 | Small-Unit Tactics | Analyzing terrain for tactical gains, planning assaults and ambushes, identifying chokepoints and vulnerabilities, and predicting engagement outcomes before the first shot. |
...
| 62 | Tactical Interrogation | Extracting information from uncooperative sources using psychological pressure, controlled rapport, and patience. Knowing when to push, wait, or when someone is lying to tell you what you want to hear. |
| 63 | Tactical Maintenance | Keeping engines operational in the field, improvising repairs without proper parts, and knowing how to disable a vehicle or machine to cause failure at the worst moment. |
| 64 | Tactical Vehicle Operations | Advanced training in pursuit and evasion driving, armored vehicle operation, maintaining control under fire or in tough terrain, and field maintenance in operational conditions. |
| 65 | Technical Intelligence Analysis | Advanced academic knowledge in a chosen field — physics, chemistry, biology, or a related discipline — applicable to analyzing unknown materials, understanding weapon systems, or interpreting paranormal phenomena. Choose your field when you take this skill. |
| 66 | Vehicle Weapons Systems | Operating vehicle-mounted weapon systems, from pintle-mounted machine guns to tank main guns, including target acquisition, lead calculation, and system maintenance during combat. |
