...
The GM will ask which attribute you’re using for your *action roll*, or they might decide for you if the answer is unclear. Before you roll, you can ask the GM for possible outcomes of your action to get a sense of what you’re up against.

- Roll +**STRENGTH** for displays of brawn and power, such as kicking in doors, intimidating others, or wielding heavy, powerful weapons.
- Roll +**REFLEXES** for feats of agility and speed, such as dodging bullets, evading enemy attacks, or wielding light, precise weapons.
- Roll +**TACTICS** for applications of logic and training, such as maintaining a disguise, hacking a database, or operating machinery.
- Roll +**WILLPOWER** for expressions of presence and control, such as delivering persuasive speeches, bluffing on the fly, or using psionic talents.

**Examples**:

- “I kick down the door and fire my shotgun at anything I see." (Roll +STRENGTH)
- "I run through the house, slide into cover, and fire from there." (Roll +REFLEXES)
- "I go around to the side of the house, flank them, and fire through the window." (Roll +TACTICS)
...
You can spend your momentum points to gain bonuses or resist incoming consequences.
...
If your action is more difficult than usual due to narrative circumstances, such as firing a weapon beyond its effective range, the GM may impose ***disadvantage***; roll 3D6 +Attribute and drop the *highest* D6.
...
To add tension to your *action roll*, ask the GM, “What would adding tension look like here?” The GM then offers an additional *consequence* for failure, such as checking off more segments on a danger clock, inflicting collateral damage, or heightening the narrative’s drama.
...
When the players face a complex obstacle, such as hacking into a mainframe or defusing a bomb, the GM may split the effort into a progress *clock* rather than resolving it with a single *action roll*.
