...
Range bands also determine the attack modifiers for your weapons; sidearms aren't as accurate as rifles when firing on enemies in a *far* range band. See [Weapon Ranges](combat.md#range-modifiers).
